...
declare namespace ReactGridLayout {
    interface LayoutItem {
        ...
        /**
         * If true, item is placeholder.
         */
        placeholder?: boolean;

        /**
         * If true, item is currently dragged between columns. Can be true only when insertColumnMode is true in GridLayout component
         */
        isBetween?: boolean;
    }
    ...
    interface ReactGridLayoutProps extends CoreProps {
        ...
        /**
         * If true, column insert mode is enabled.
         */
